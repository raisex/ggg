...
var (
	...
	GCBIBGenesisHash = common.HexToHash("0x82270b80fc90beb005505a9ef95039639968a0e81b2904ad30128c93d713d2c4")
)
...
var (
	...
	// GCBIBChainConfig is the chain parameters to run a node on the GCBIB main network.
	GCBIBChainConfig = &ChainConfig{
...
type ChainConfig struct {
	...
	CLOHF1Block *big.Int `json:"clohf1Block,omitempty"` // GCBIB Hardfork 1 block
